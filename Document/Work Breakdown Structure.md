...
|17-22|Enemy Following| Trying to make a start attacking and following componet to monsters, so they follow player|Medium|3 days|Done|Trying to make it so only works in certain range of player|
